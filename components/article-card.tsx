...
export function ArticleCard({
  ...
  return (
    <Card className="p-5 transition-all duration-200 hover:border-indigo-500/50 hover:shadow-md">
      ...
      <div className="flex items-center justify-between">
        <a
          ...
          className="text-sm text-indigo-500 hover:text-indigo-600 inline-flex items-center gap-1 transition-colors"
        >
          Read original
        ...
        <Button
          ...
          className="bg-indigo-500 hover:bg-indigo-600 text-white disabled:opacity-100"
        >
          {justAnalyzed ? (
            <>
